...
create or replace transient table TUKI_DB.TUKI_DEV_SCHEMA.g_playlist_performance
...
best as (
  ...
  from TUKI_DB.TUKI_DEV_SCHEMA.stg_videos v
...
from TUKI_DB.TUKI_DEV_SCHEMA.stg_playlists p
